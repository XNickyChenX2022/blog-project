        ...
        if not username or not password or not conformation:
            ...
            if Users.query.filter_by(username=username).first():
                ...
                if check_valid_password(password) == False:
                    flash('Invalid Password: Passwords must include a special character, an uppercase letter, a lowercase letter, and should be at least 12 characters', category='error')
